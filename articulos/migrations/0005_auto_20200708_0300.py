# Generated by Django 3.0.7 on 2020-07-08 08:00
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('articulos', '0004_auto_20200708_0259'),
    ]
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='articulos1',
            name='familia',
            field=models.ForeignKey(blank=True, help_text='Familia', on_delete=django.db.models.deletion.CASCADE, to='articulos.Familia1'),
        ),
        migrations.AddField(
            model_name='articulos1',
            name='medida',
            field=models.ForeignKey(help_text='Unidad de medida', on_delete=django.db.models.deletion.CASCADE, to='articulos.Medida1'),
        ),
    ]
